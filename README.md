...
✔️ Poker game logic validated by automated unit tests

✔️ Structured code for deck, cards, hands, and game rounds

✔️ Clean modular design using Python packages and modules

## Why TDD?

Test-Driven Development (TDD) is a software development practice where tests are written before the actual production code. This process ensures:

1.Tests define how code should behave first (Red)

2.Production code is written until tests pass (Green)

3.Code is refactored for clarity and maintainability (Refactor)

4.The cycle Red → Green → Refactor helps produce reliable code and reduces bugs early in development.
